...
const Edition = () => {
  return (
    <section
      name="Edition"
      className="relative text-white p-4 py-10 grid gap-10 sm:grid-cols-2 max-w-[1000px] mx-auto"
    >
      {/* Seccion izquierda */}
      <section className="grid gap-10">
        <div>
          ...
          <h2 className="text-3xl font-semibold mt-2">
            Some videos that I have edited.
          </h2>
        </div>
        ...
        <article className="bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden">
          <div>
            <img
              src="/images/videosImages/reel-diego.webp"
              alt="reel-diego"
              loading="lazy"
            />
          </div>
          <section className="p-6">
            ...
            <p className="text-gray-400 text-md mt-2">
              Demo reel by Diego Téllez Contreras, video editor located in the
              city of Bogotá with more than 7 years of experience in the
              post-production of all kinds of audiovisual products.
            </p>
            <a
              href="https://youtu.be/ZaNV03Y6Yfo"
              target="_blank"
        ...
        <article className="bg-gray-d relative border-[1px] border-primary-color/30 rounded-lg overflow-hidden">
          <div>
            <img
              src="/images/videosImages/informal.webp"
              alt="informal employment"
              loading="lazy"
            />
          </div>
          <section className="p-6">
            ...
            <p className="text-gray-400 text-md mt-2">
              ...
              Caracol. Journalist: Marcela Pulido. Editing and coloring: Diego
              Téllez. Language: spanish. December 2020.
            </p>
            <a
              href="https://youtu.be/T23Vnz8hcPc"
              target="_blank"
              className="bg-gradient-to-t from-green-400 to-primary-color p-1 absolute bottom-0 right-0 text-lg"
            >
              <i className="bx bx-link text-black"></i>
